...
flags.DEFINE_string('root_dir', '~/tmp/ICubExample',
...
parallel_num = 8
collect_episodes_per_iteration_num = 16
train_num_epochs = 25
log_interval = 50
...
def train_eval(
        root_dir,
        env_name='SocialBot-ICub-v0',
        env_load_fn=suite_socialbot.load,
        random_seed=0,
        # TODO(b/127576522): rename to policy_fc_layers.
        actor_fc_layers=(300, 128),
        value_fc_layers=(300, 128),
        use_rnns=False,
        # Params for collect
        num_environment_steps=10000000,
        collect_episodes_per_iteration=collect_episodes_per_iteration_num,
