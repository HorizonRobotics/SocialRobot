...
* [Ball task](python/social_bot/envs/grocery_ground.py): A task to kick a ball to the goal. Simple reward shaping is used to guide the agent run to the ball firstly.
