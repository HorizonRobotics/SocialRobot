...
class EmbodiedTeacher(PlayGround):
    """
    This envionment is the playgound with a  have a embodied teacher on
    it. It support demonstrations by teacher's movements. The demonstrations
    could be generated by an existing teacher policy or by human control
    interface.
    ...
    def __init__(self,
        ...
        Args:
            ...
            is_training_for_teacher_policy (bool): if true this env is acting like a normal
                gym environment without teacher, used for training the teacher policy
